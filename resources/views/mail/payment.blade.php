                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:120px;">
                                                            ...
                                                            <img height="auto" src="{{ asset('image/blacklogo.png') }}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" />
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#525252;">
                                                ...
                                                <p>Muito obrigado pela sua confiança em nossos serviços. Estamos muito felizes em ter você como nosso cliente. Por favor, acesse o link abaixo para realizar o pagamento.</p>
                                            </div>
                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    ...
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ $value }}</td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Atenciosamente,<br><br> Gustavo Airton<br>Fundador da bexond.com<br>
                                                <a href="https://bexond.com" style="color:#2F67F6">bexond.com</a>
                                            </div>
